# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2017-09-15 17:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdTime', models.DateTimeField(auto_now_add=True, db_column='created_time', help_text='该记录创建时间', null=True, verbose_name='记录创建时间')),
                ('updatedTime', models.DateTimeField(auto_now=True, db_column='updated_time', help_text='记录最后更新时间', null=True, verbose_name='记录最后更新时间')),
                ('deptId', models.ForeignKey(db_column='dept_id', db_index=False, help_text='请选择部门', on_delete=django.db.models.deletion.CASCADE, to='account.SysDept', verbose_name='部门编号，外键')),
                ('titleId', models.ForeignKey(db_column='title_id', db_index=False, help_text='请输入职位', on_delete=django.db.models.deletion.CASCADE, to='account.SysTitle', verbose_name='职位编号，外键')),
                ('userMgrid', models.ForeignKey(db_column='user_mgrid', db_index=False, help_text='用户领导id，0为管理员用户，自外键', on_delete=django.db.models.deletion.CASCADE, to='account.SysUser', verbose_name='用户领导id')),
            ],
            options={
                'verbose_name': '用户信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdTime', models.DateTimeField(auto_now_add=True, db_column='created_time', help_text='该记录创建时间', null=True, verbose_name='记录创建时间')),
                ('updatedTime', models.DateTimeField(auto_now=True, db_column='updated_time', help_text='记录最后更新时间', null=True, verbose_name='记录最后更新时间')),
                ('groupId', models.ForeignKey(db_column='group_id', db_index=False, help_text='用户组 ID', on_delete=django.db.models.deletion.CASCADE, to='account.SysGroup', verbose_name='用户组 ID')),
                ('userId', models.ForeignKey(db_column='user_id', db_index=False, help_text='用户 ID', on_delete=django.db.models.deletion.CASCADE, to='account.SysUser', verbose_name='用户 ID')),
            ],
            options={
